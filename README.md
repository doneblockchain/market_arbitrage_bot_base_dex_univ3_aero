...
###
Rename .env-example to .env and enter required info private key of wallet and alchemy api key on base network need to 
create app there on base and copy api key
...
- I add as much tokens as i can but these are not all there are much more tokens to be added.
Find tokens on geckoterminal.com choose network base dex uniswap v3

- How to add tokens??
1. copy pool id from geckoterminal for uniswap see and pool fee and if is 1 enter 10000 of its 0.3 enter 3000 if its
0.05 enter 500 etc. Where to do that in bot.js current line 126
2. At line 138
...
3. line 935
    ...
    } /* NOV TOKEN SMENI ADRESA I POOL_FEE_ETH_EMP_PANCAKE i POOL_FEE_ETH_EMP_AERODROME
    else if (_token1.address == '0x39d5313c3750140e5042887413ba8aa6145a9bd2') { //emp adresa na tokenot smeni ja 
...
BITNO****
NEKA NE VE BUNI SO PISUVA PANCAKE I AERODROME. PANCAKE E UNISWAP V3 AURODROME E AERODROM DEX NA BASE NETWORK
PORADI ISTORISKI PRICINI SE OVIE IMINJA PRENAMENET E BOTOV KE TREBASE SEKADE DA MENJAVAM IMINJA ME MRZESE PA TAKA PANCAKE E UNISWAP V3 AERODROME E AERODROME